...
import com.ammar.shreeKrishnaNationalSchoolOfExcellence.KidsCorner.balloonpoper.utils.HighScoreHelper;
import com.ammar.shreeKrishnaNationalSchoolOfExcellence.KidsCorner.balloonpoper.utils.SimpleAlertDialog;
import com.ammar.shreeKrishnaNationalSchoolOfExcellence.KidsCorner.balloonpoper.utils.SoundHelper;
...
public class BalloonMain extends AppCompatActivity implements Balloon.BalloonListener {
    ...
    private TextView mScoreDisplay, mLevelDisplay, mAlphabet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.balloon_main_activity);
        ...
        mAlphabet = findViewById(R.id.balloonletter);
    ...
    private  void startLevel() {
        ...
        mAlphabet.setText(Character.toString(currentAlphabet));
    ...
    public void popBalloon(Balloon balloon, boolean user_touch) {
        ...
        if(user_touch) {
            if(balloon.isAlphabet)
            {
                mScore++;
            }
            updateDisplay();
        } else if(balloon.isAlphabet){
            mPinsUsed++;
...
//              Wait a random number of milliseconds before looping
    ...
    private void launchBalloon(int x) {
        ...
        if(random == 0)
        {
            balloon = new Balloon(this, mBalloonColors[mNextColor], 150, false, "");
        }
        else{
            balloon = new Balloon(this, mBalloonColors[mNextColor], 150, true, Character.toString(currentAlphabet));
        }
